...
<section class="home" >
       <div class="home-content">
            <h2>Hi👋,Welcome to OrdiShop </h2>
            <h3>We have some new offers</h3>
          <div class="btn-box">
            <a href="">Read More</a>
            <a href="">Contact</a>
          </div>      
          ...
          <div id="slider" class="carousel slide">
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <img class="d-block w-100" src="../img/slider/pub.jpg" alt="Slide 1">
                  </div>
                  <div class="carousel-item">
                      <img class="d-block w-100" src="../img/slider/pub2.jpg" alt="Slide 2">
                  </div>
              </div>
